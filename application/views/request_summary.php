<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-5">
        <span class="navbar-brand">Request Summary Page
            <br>
    ...
    <div class="container">
        ...
        <div class="content-header">
            ...
            <!-- Title -->
            <span class="content-title">Request Details</span>
            ...
            <table class="table table-striped border">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border"><?php echo $request_details['request_id']?></td>
                    </tr>
                    <tr>
                        <!-- Number -->
                        <td class="border">Manifest ID</td>
                        <td class="border"><?php echo $request_details['manifest_id']?></td>
                    </tr>
                    <tr>
                        <!-- Number -->
                        <td class="border">Destination Facility</td>
                        <td class="border"><?php echo $request_details['destination_facility']?></td>
                    </tr>
                    <tr>
                        <!-- Number -->
                        <td class="border">Pickup Facility</td>
                        <td class="border"><?php echo $request_details['pickup_facility']?></td>
                    </tr>
                    <tr>
                        <!-- Number -->
                        <td class="border">Pickup Date and Time</td>
                        <td class="border"><?php echo $request_details['pickup_date_time']?></td>
                    </tr>
